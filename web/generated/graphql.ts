...
export type LlmMetrikleriQueryVariables = Exact<{
  sonSaat?: number | null | undefined;
}>;


export type LlmMetrikleriQuery = { llmMetrikleri: { toplamCagri: number, basariliCagri: number, basarisizCagri: number, ortalamaSureMs: number, p95SureMs: number, agentBazinda: Array<{ agent: PromptTipi, cagri: number, ortalamaSureMs: number, basariOrani: number }>, ucBazinda: Array<{ ucAdi: string, cagri: number, ortalamaSureMs: number, basariOrani: number }>, hataDagilimi: Array<{ hataTipi: string, adet: number }> } };

export type LlmCagrilariQueryVariables = Exact<{
  limit?: number | null | undefined;
}>;


export type LlmCagrilariQuery = { llmCagrilari: Array<{ agent: PromptTipi, ucAdi: string, sureMs: number, basarili: boolean, hataTipi: string, denemeNo: number, baslangic: string }> };
...
export const LlmMetrikleriDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LlmMetrikleri"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sonSaat"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"llmMetrikleri"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"sonSaat"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sonSaat"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"toplamCagri"}},{"kind":"Field","name":{"kind":"Name","value":"basariliCagri"}},{"kind":"Field","name":{"kind":"Name","value":"basarisizCagri"}},{"kind":"Field","name":{"kind":"Name","value":"ortalamaSureMs"}},{"kind":"Field","name":{"kind":"Name","value":"p95SureMs"}},{"kind":"Field","name":{"kind":"Name","value":"agentBazinda"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"agent"}},{"kind":"Field","name":{"kind":"Name","value":"cagri"}},{"kind":"Field","name":{"kind":"Name","value":"ortalamaSureMs"}},{"kind":"Field","name":{"kind":"Name","value":"basariOrani"}}]}},{"kind":"Field","name":{"kind":"Name","value":"ucBazinda"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ucAdi"}},{"kind":"Field","name":{"kind":"Name","value":"cagri"}},{"kind":"Field","name":{"kind":"Name","value":"ortalamaSureMs"}},{"kind":"Field","name":{"kind":"Name","value":"basariOrani"}}]}},{"kind":"Field","name":{"kind":"Name","value":"hataDagilimi"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hataTipi"}},{"kind":"Field","name":{"kind":"Name","value":"adet"}}]}}]}}]}}]} as unknown as DocumentNode<LlmMetrikleriQuery, LlmMetrikleriQueryVariables>;
export const LlmCagrilariDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LlmCagrilari"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"llmCagrilari"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"agent"}},{"kind":"Field","name":{"kind":"Name","value":"ucAdi"}},{"kind":"Field","name":{"kind":"Name","value":"sureMs"}},{"kind":"Field","name":{"kind":"Name","value":"basarili"}},{"kind":"Field","name":{"kind":"Name","value":"hataTipi"}},{"kind":"Field","name":{"kind":"Name","value":"denemeNo"}},{"kind":"Field","name":{"kind":"Name","value":"baslangic"}}]}}]}}]} as unknown as DocumentNode<LlmCagrilariQuery, LlmCagrilariQueryVariables>;
