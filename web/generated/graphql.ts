...
export type SozlesmelerQuery = { sozlesmeler: Array<{ id: string, dosyaAdi: string | null, durum: SozlesmeDurumu, olusturmaTarihi: string, guncellemeTarihi: string, meta: { otelAdi: string | null, acenteAdi: string | null } | null, donem: { baslangic: string | null, bitis: string | null } | null }> };
