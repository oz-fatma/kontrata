...
| `LLM_ENDPOINT_URL` | PDF çıkarımı için | — | HuggingFace Inference Endpoint 1 |
| `LLM_TOKEN` | PDF çıkarımı için | — | Uç 1 jetonu. Günlüğe yazılmaz. |
...
`MAILER=console` iken e-posta doğrulama ve MFA kodları API günlüğüne yazılır.
